...
// the normal is 0, everything else just remains the same
// (ok, would be doable, but I am to tired.)
void SlipTop::setUVW()
{
...
// I think, the fgh remain, but p is dependend on u and f
void SlipTop::setFGH()
{
    #pragma omp simd collapse(2)
    for(int k = 1; k < ukLen_-1; k++)
